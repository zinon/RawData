...
## Tau Selection
tau_pt = 15000.
req_tau_ntrack1or3 = False
req_tau_abscharge1 = False
...
#max_events = 50000
tree_name = 'tauPerf'
tree2_name = 'tauPerfMeta/TrigConfTree'
branches = ['*']
    ...
    #    if i_event == 1000: break
      ...
      for i_tau in xrange(ch.tau_n):
          if ch.tau_Et[i_tau] >= tau_pt and abs(ch.tau_eta[i_tau]) < 3.  :
              if req_tau_ntrack1or3 and not ( ch.tau_seedCalo_numTrack[i_tau] == 1 or ch.tau_seedCalo_numTrack[i_tau] == 3 ): continue
